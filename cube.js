...
function cubeDemo() {
    console.log('cubeDemo running');

    var canvas = document.getElementById('cube-game');
    ...
    var loop = function () {
        ...
        glMatrix.mat4.rotate(xRotMatrix, identityMatrix, angle / 4, [1, 0, 0]);
