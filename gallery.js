...
function resizeAll() {
    ...
    for (let els of galleryElements) {
        ...
        let clampHeight = (Number(item2.height.slice(0, -2)) - item2.firstChild.offsetHeight - item2.lastChild.offsetHeight) / 22.4;
        console.log(Number(item2.height.slice(0, -2))t, item2.firstChild.offsetHeight, item2.lastChild.offsetHeight);
